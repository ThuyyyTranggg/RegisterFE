                ...
                <div className="sidebar-content">
                    ...
                    <div className="sidebar-menu">
                        <ul>
                            ...
                            <li className={selectedMenuItem === 'dangkiDeTai' ? 'active' : ''}><Link to="/registerTopicofHead" onClick={() => handleMenuItemClick('dangkiDeTai')}><i className="fa fa-book"></i><span>Đăng ký đề tài</span></Link></li>
